/*
    Compile unit: C:\WINDOWS\Profiles\slee\Desktop\ENGLISH ZELDA\Core\xlHeap.c
...
// size = 0x4, address = 0x80137AA8
static u32* gpHeap;

// size = 0x4, address = 0x80137AAC
static u32* gpHeapBlockFirst;

// size = 0x4, address = 0x80137AB0
static u32* gpHeapBlockLast;

// size = 0x4, address = 0x80137AB4
static s32 gnHeapTakeCount;

// size = 0x4, address = 0x80137AB8
static s32 gnHeapFreeCount;

// size = 0x4, address = 0x80137ABC
static s32 gnHeapTakeCacheCount;

// size = 0x580, address = 0x800F64B0
static u32* gapHeapBlockCache[11][32];

// size = 0x4, address = 0x80137AC0
s32 gnSizeHeap;
