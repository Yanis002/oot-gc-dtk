/*
    Compile unit: C:\WINDOWS\Profiles\slee\Desktop\ENGLISH ZELDA\Core\xlFileGCN.c
...
} __anon_0x1A07; // size = 0x10

// size = 0x10, address = 0x800DB860
...
} __anon_0x1EEE; // size = 0x3C

// size = 0x4, address = 0x80137AA0
static s32 (* gpfOpen)(char*, struct DVDFileInfo*);

// size = 0x4, address = 0x80137AA4
...
typedef struct tXL_FILE {
    ...
    /* 0x10 */ s32 nSize;
    /* 0x14 */ s32 nOffset;
    /* 0x18 */ enum __anon_0x2772 eType;
    /* 0x1C */ struct DVDFileInfo info;
} __anon_0x20A0; // size = 0x58

typedef enum __anon_0x2772 {
    XLFT_NONE = -1,
    XLFT_TEXT = 0,
    XLFT_BINARY = 1,
} __anon_0x2772;
...
s32 xlFileOpen(struct tXL_FILE** ppFile, enum __anon_0x2772 eType, char* szFileName) {
    // Parameters
    // struct tXL_FILE** ppFile; // r29
    // enum __anon_0x2772 eType; // r30
    // char* szFileName; // r31
