/*
    Compile unit: C:\WINDOWS\Profiles\slee\Desktop\ENGLISH ZELDA\Core\xlObject.c
...
typedef struct tXL_LIST {
    ...
    /* 0x8 */ void* pNodeHead;
    /* 0xC */ void* pNodeNext;
} __anon_0x4EAE; // size = 0x10

// size = 0x4, address = 0x80137AC8
...
} __anon_0x4FD7; // size = 0x10

typedef struct __anon_0x50A1 {
    /* 0x0 */ struct tXL_LIST* pList;
    /* 0x4 */ struct _XL_OBJECTTYPE* pType;
} __anon_0x50A1; // size = 0x8

// Erased
static s32 xlObjectFindData(struct __anon_0x50A1** ppData, struct _XL_OBJECTTYPE* pType) {
    // Parameters
    // struct __anon_0x50A1** ppData; // r1+0x0
...
// Erased
static s32 xlObjectMakeData(struct __anon_0x50A1** ppData, struct _XL_OBJECTTYPE* pType) {
    // Parameters
    // struct __anon_0x50A1** ppData; // r30
...
s32 xlObjectMake(void* ppObject, void* pArgument, struct _XL_OBJECTTYPE* pType) {
    ...
    // Local variables
    s32 bFlag; // r31
    struct __anon_0x50A1* pData; // r1+0x14
...
s32 xlObjectFree(void* ppObject) {
    ...
    // Local variables
    struct __anon_0x50A1* pData; // r31
}
...
s32 xlObjectEvent(void* pObject, s32 nEvent, void* pArgument) {
    ...
    // Local variables
    struct __anon_0x50A1* pData; // r29
