/*
    Compile unit: C:\WINDOWS\Profiles\slee\Desktop\ENGLISH ZELDA\Fire\cpu.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80030EEC -> 0x800368EC
*/
...
typedef struct __anon_0x3DBEB {
    /* 0x00 */ void* pFrame;
    /* 0x04 */ void* pSound;
    /* 0x08 */ s32 bException;
    /* 0x0C */ enum __anon_0x3D871 eMode;
    /* 0x10 */ struct __anon_0x3D8D3 romCopy;
    /* 0x20 */ enum __anon_0x3D984 eTypeROM;
    /* 0x24 */ void* apObject[16];
    /* 0x68 */ u64 nAddressBreak;
    /* 0x70 */ enum __anon_0x3DAB0 storageDevice;
    /* 0x74 */ u8 anException[16];
    /* 0x84 */ s32 bJapaneseVersion;
} __anon_0x3DBEB; // size = 0x88

// size = 0x4, address = 0x80137B00
struct __anon_0x3DBEB* gpSystem;

typedef struct __anon_0x3DF4F {
    /* 0x0 */ s32 nOffsetHost;
    /* 0x4 */ s32 nAddressN64;
} __anon_0x3DF4F; // size = 0x8

typedef struct cpu_callerID {
    /* 0x0 */ s32 N64address;
    /* 0x4 */ s32 GCNaddress;
} __anon_0x3DFB5; // size = 0x8

typedef struct cpu_function {
    /* 0x00 */ void* pnBase;
    /* 0x04 */ void* pfCode;
    /* 0x08 */ s32 nCountJump;
    /* 0x0C */ struct __anon_0x3DF4F* aJump;
    /* 0x10 */ s32 nAddress0;
    /* 0x14 */ s32 nAddress1;
...
} __anon_0x3E028; // size = 0x48

typedef union __anon_0x3E304 {
    /* 0x0 */ char _0s8;
    /* 0x1 */ char _1s8;
    /* 0x2 */ char _2s8;
    /* 0x3 */ char _3s8;
...
} __anon_0x3EEF4; // size = 0x84

typedef struct __anon_0x3F157 {
    /* 0x0 */ u32 nAddress;
    /* 0x4 */ u32 nOpcodeOld;
    /* 0x8 */ u32 nOpcodeNew;
} __anon_0x3F157; // size = 0xC
...
typedef struct _CPU {
    ...
    /* 0x00040 */ union __anon_0x3E304 aGPR[32];
    /* 0x00140 */ union __anon_0x3E718 aFPR[32];
    ...
    /* 0x00B64 */ struct __anon_0x3EC26* apDevice[256];
    ...
    /* 0x11EA8 */ struct __anon_0x3F157 aCodeHack[32];
...
} __anon_0x3FF33; // size = 0x40

typedef enum __anon_0x4304A {
    CS_NONE = -1,
    CS_32BIT = 0,
    CS_64BIT = 1,
} __anon_0x4304A;

typedef enum __anon_0x43BE1 {
    RLM_NONE = -1,
    RLM_PART = 0,
    RLM_FULL = 1,
    RLM_COUNT_ = 2,
...
typedef struct __anon_0x43C40 {
    /* 0x0 */ s32 iCache;
    /* 0x4 */ u32 nSize;
    /* 0x8 */ u32 nTickUsed;
    /* 0xC */ char keep;
} __anon_0x43C40; // size = 0x10

typedef struct __anon_0x43D54 {
    /* 0x00 */ s32 bWait;
    /* 0x04 */ s32 (* pCallback)();
    /* 0x08 */ u8* pTarget;
    /* 0x0C */ u32 nSize;
    /* 0x10 */ u32 nOffset;
} __anon_0x43D54; // size = 0x14

typedef struct __anon_0x43E34 {
    /* 0x00 */ s32 bWait;
    /* 0x04 */ s32 bDone;
    /* 0x08 */ s32 nResult;
    /* 0x0C */ u8* anData;
...
} __anon_0x44415; // size = 0x3C

typedef struct __anon_0x444CD {
    /* 0x00000 */ void* pHost;
    ...
    /* 0x00214 */ u32 nSize;
    /* 0x00218 */ enum __anon_0x43BE1 eModeLoad;
    /* 0x0021C */ struct __anon_0x43C40 aBlock[4096];
    /* 0x1021C */ u32 nTick;
    /* 0x10220 */ u8* pCacheRAM;
    /* 0x10224 */ u8 anBlockCachedRAM[1024];
    /* 0x10624 */ u8 anBlockCachedARAM[2046];
    /* 0x10E24 */ struct __anon_0x43D54 copy;
    /* 0x10E38 */ struct __anon_0x43E34 load;
...
typedef enum __anon_0x44900 {
    RUM_NONE = 0,
    RUM_IDLE = 1,
} __anon_0x44900;

typedef enum __anon_0x44BC0 {
    CM_NONE = -1,
    CM_USER = 0,
    CM_SUPER = 1,
    CM_KERNEL = 2,
...
static s32 cpuHackIdle(struct _CPU* pCPU) {
    ...
    // Local variables
    struct __anon_0x3DBEB* pSystem; // r3
}
...
// Range: 0x800360C8 -> 0x80036388
s32 cpuException(struct _CPU* pCPU, enum __anon_0x45BB8 eCode, s32 nMaskIP) {
    // Parameters
    // struct _CPU* pCPU; // r27
    // enum __anon_0x45BB8 eCode; // r28
    // s32 nMaskIP; // r29
}

// Range: 0x80035FB8 -> 0x800360C8
static s32 cpuMakeDevice(struct _CPU* pCPU, s32* piDevice, void* pObject, s32 nOffset, u32 nAddress0, u32 nAddress1, s32 nType) {
    ...
    // Local variables
    struct __anon_0x3EC26* pDevice; // r1+0x28
    s32 iDevice; // r31
}

// Range: 0x80035F14 -> 0x80035FB8
...
// Range: 0x80035990 -> 0x80035A68
static s32 cpuGetMode(u64 nStatus, enum __anon_0x44BC0* peMode) {
    // Parameters
    // u64 nStatus; // r1+0x0
    // enum __anon_0x44BC0* peMode; // r1+0x8
}

// Range: 0x8003584C -> 0x80035990
static s32 cpuGetSize(u64 nStatus, enum __anon_0x4304A* peSize, enum __anon_0x44BC0* peMode) {
    // Parameters
    // u64 nStatus; // r29
    // enum __anon_0x4304A* peSize; // r30
    // enum __anon_0x44BC0* peMode; // r31

    // Local variables
    enum __anon_0x44BC0 eMode; // r1+0x18
}
...
static s32 cpuSetCP0_Status(struct _CPU* pCPU, u64 nStatus) {
    ...
    // Local variables
    enum __anon_0x44BC0 eMode; // r1+0x28
    enum __anon_0x44BC0 eModeLast; // r1+0x24
    enum __anon_0x4304A eSize; // r1+0x20
    enum __anon_0x4304A eSizeLast; // r1+0x1C
}

// Range: 0x800355EC -> 0x800357B8
...
// Range: 0x800352A8 -> 0x80035344
s32 __cpuERET(struct _CPU* pCPU) {
    // Parameters
    // struct _CPU* pCPU; // r1+0x0
}

// Range: 0x80035294 -> 0x800352A8
...
// Range: 0x800350CC -> 0x800350E4
s32 cpuSetDeviceGet(struct __anon_0x3EC26* pDevice, s32 (* pfGet8)(void*, u32, char*), s32 (* pfGet16)(void*, u32, s16*), s32 (* pfGet32)(void*, u32, s32*), s32 (* pfGet64)(void*, u32, s64*)) {
    // Parameters
    // struct __anon_0x3EC26* pDevice; // r1+0x4
...
// Range: 0x800350B4 -> 0x800350CC
s32 cpuSetDevicePut(struct __anon_0x3EC26* pDevice, s32 (* pfPut8)(void*, u32, char*), s32 (* pfPut16)(void*, u32, s16*), s32 (* pfPut32)(void*, u32, s32*), s32 (* pfPut64)(void*, u32, s64*)) {
    // Parameters
    // struct __anon_0x3EC26* pDevice; // r1+0x4
...
static s32 cpuGetGPR(struct _CPU* pCPU, s32* anRegister) {
    ...
    // Local variables
    s32 iRegister; // r1+0x8
    enum __anon_0x4304A eSize; // r1+0x18
...
s32 cpuGetAddressBuffer(struct _CPU* pCPU, void* ppBuffer, u32 nAddress) {
    ...
    // Local variables
    struct __anon_0x3EC26* pDevice; // r1+0x8
}

// Range: 0x8003466C -> 0x800347FC
...
s32 cpuFindFunction(struct _CPU* pCPU, s32 theAddress, struct cpu_function** tree_node) {
    ...
    // Local variables
    struct __anon_0x3EC26** apDevice; // r26
    u8* aiDevice; // r27
    u32 opcode; // r1+0x34
    u8 follow; // r1+0x3D
    u8 valid; // r16
