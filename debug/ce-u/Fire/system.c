/*
    Compile unit: C:\WINDOWS\Profiles\slee\Desktop\ENGLISH ZELDA\Fire\system.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8002CA20 -> 0x80030EEC
*/

#include "types.h"

// size = 0x4, address = 0x80137360
u32 nTickMultiplier;

// size = 0x4, address = 0x80137364
f32 fTickScale;
...
} __anon_0x34481; // size = 0x10

// size = 0x10, address = 0x800ED810
struct _XL_OBJECTTYPE gClassSystem;

// size = 0x140, address = 0x800ED820
static u32 contMap[4][20];

// size = 0x4, address = 0x80137BD8
u32 gnFlagZelda;

typedef struct __anon_0x34665 {
    /* 0x000 */ char rom[36];
...
} __anon_0x34665; // size = 0x174

// size = 0x174, address = 0x80132DE0
struct __anon_0x34665 gSystemRomConfigurationList[1];

typedef struct __anon_0x3482F {
    /* 0x0 */ f32 rX;
    /* 0x4 */ f32 rY;
    /* 0x8 */ f32 rSizeX;
    /* 0xC */ f32 rSizeY;
} __anon_0x3482F; // size = 0x10

typedef struct __anon_0x348C9 {
    /* 0x00 */ s32 nSize;
    /* 0x04 */ s32 nWidth;
    /* 0x08 */ s32 nFormat;
    /* 0x0C */ void* pData;
    /* 0x10 */ s32 nAddress;
} __anon_0x348C9; // size = 0x14

typedef struct __anon_0x34A0A {
    /* 0x0 */ f32 x;
    /* 0x4 */ f32 y;
    /* 0x8 */ f32 z;
} __anon_0x34A0A; // size = 0xC

typedef struct __anon_0x34A7A {
    /* 0x00 */ s32 bTransformed;
    /* 0x04 */ struct __anon_0x34A0A rVecOrigTowards;
    /* 0x10 */ f32 rColorR;
    /* 0x14 */ f32 rColorG;
    /* 0x18 */ f32 rColorB;
    /* 0x1C */ f32 rVectorX;
    ...
    /* 0x36 */ s16 coordY;
    /* 0x38 */ s16 coordZ;
} __anon_0x34A7A; // size = 0x3C

typedef struct __anon_0x34CAA {
    /* 0x00 */ s32 bTransformed;
    /* 0x04 */ struct __anon_0x34A0A rS;
    /* 0x10 */ struct __anon_0x34A0A rT;
    /* 0x1C */ struct __anon_0x34A0A rSRaw;
    /* 0x28 */ struct __anon_0x34A0A rTRaw;
} __anon_0x34CAA; // size = 0x34

typedef struct __anon_0x34D93 {
    /* 0x00 */ f32 rSum;
    /* 0x04 */ f32 rS;
    /* 0x08 */ f32 rT;
    /* 0x0C */ struct __anon_0x34A0A vec;
    /* 0x18 */ u8 anColor[4];
} __anon_0x34D93; // size = 0x1C

typedef union __anon_0x34EF2 {
    /* 0x0 */ u8 u8[4096];
    /* 0x0 */ u16 u16[2048];
    /* 0x0 */ u32 u32[1024];
    /* 0x0 */ u64 u64[512];
...
typedef struct __anon_0x34F8F {
    /* 0x0 */ union __anon_0x34EF2 data;
} __anon_0x34F8F; // size = 0x1000
...
typedef struct _GXTlutObj {
    /* 0x0 */ u32 dummy[3];
} __anon_0x351EA; // size = 0xC

typedef struct _GXTexObj {
    /* 0x0 */ u32 dummy[8];
} __anon_0x35251; // size = 0x20
...
} __anon_0x35300; // size = 0x6C

typedef struct __anon_0x3565D {
    /* 0x00 */ s32 nSize;
    /* 0x04 */ s32 nTMEM;
    /* 0x08 */ s32 iTLUT;
    /* 0x0C */ s32 nSizeX;
    ...
    /* 0x26 */ s16 nY1;
    /* 0x28 */ u32 nCodePixel;
} __anon_0x3565D; // size = 0x2C

typedef enum __anon_0x3593F {
    FMP_NONE = -1,
    FMP_PERSPECTIVE = 0,
    FMP_ORTHOGRAPHIC = 1,
} __anon_0x3593F;

typedef struct __anon_0x359C3 {
    /* 0x00 */ s32 nCount;
    /* 0x04 */ f32 rScale;
    /* 0x08 */ f32 rAspect;
    ...
    /* 0x20 */ enum __anon_0x3593F eProjection;
} __anon_0x359C3; // size = 0x24
...
typedef struct _GXColor {
    ...
    /* 0x2 */ u8 b;
    /* 0x3 */ u8 a;
} __anon_0x35B58; // size = 0x4

typedef struct __anon_0x35C13 {
    ...
    /* 0x000B8 */ struct __anon_0x3482F viewport;
    /* 0x000C8 */ struct __anon_0x348C9 aBuffer[4];
    ...
    /* 0x00140 */ struct __anon_0x34A7A aLight[8];
    /* 0x00320 */ struct __anon_0x34CAA lookAt;
    /* 0x00354 */ s32 nCountVertex;
    /* 0x00358 */ struct __anon_0x34D93 aVertex[80];
    /* 0x00C18 */ struct __anon_0x34F8F TMEM;
    ...
    /* 0x3C350 */ s32 nLastX1;
    /* 0x3C354 */ s32 nLastY1;
    /* 0x3C358 */ struct __anon_0x3565D aTile[8];
...
} __anon_0x35C13; // size = 0x3D150

// size = 0x4, address = 0x80137B08
struct __anon_0x35C13* gpFrame;

typedef enum __anon_0x36B05 {
    SPM_NONE = -1,
    SPM_PLAY = 0,
    SPM_RAMPQUEUED = 1,
    SPM_RAMPPLAYED = 2,
...
typedef struct __anon_0x36B71 {
    ...
    /* 0xB4 */ enum __anon_0x36B05 eMode;
    ...
    /* 0xD0 */ s32 nSizeHold;
    /* 0xD4 */ s32 nSizeRamp;
} __anon_0x36B71; // size = 0xD8

// size = 0x4, address = 0x80137B04
struct __anon_0x36B71* gpSound;

// size = 0x10, address = 0x800EDB60
...
typedef struct __anon_0x37107 {
    /* 0x0 */ s32 nSize;
    /* 0x4 */ s32 nOffsetRAM;
    /* 0x8 */ s32 nOffsetROM;
    /* 0xC */ s32 (* pCallback)();
} __anon_0x37107; // size = 0x10

typedef enum __anon_0x371B8 {
    SRT_NONE = -1,
    SRT_MARIO = 0,
    SRT_WAVERACE = 1,
    SRT_MARIOKART = 2,
...
typedef struct __anon_0x37307 {
    /* 0x00 */ void* pFrame;
    /* 0x04 */ void* pSound;
    /* 0x08 */ s32 bException;
    /* 0x0C */ enum __anon_0x3A14C eMode;
    /* 0x10 */ struct __anon_0x37107 romCopy;
    /* 0x20 */ enum __anon_0x371B8 eTypeROM;
    /* 0x24 */ void* apObject[16];
    /* 0x68 */ u64 nAddressBreak;
    /* 0x70 */ enum __anon_0x39594 storageDevice;
    /* 0x74 */ u8 anException[16];
    /* 0x84 */ s32 bJapaneseVersion;
} __anon_0x37307; // size = 0x88

typedef struct __anon_0x374CF {
    /* 0x0 */ s32 nOffsetHost;
    /* 0x4 */ s32 nAddressN64;
} __anon_0x374CF; // size = 0x8

typedef struct cpu_callerID {
    /* 0x0 */ s32 N64address;
    /* 0x4 */ s32 GCNaddress;
} __anon_0x37535; // size = 0x8

typedef struct cpu_function {
    /* 0x00 */ void* pnBase;
    /* 0x04 */ void* pfCode;
    /* 0x08 */ s32 nCountJump;
    /* 0x0C */ struct __anon_0x374CF* aJump;
    /* 0x10 */ s32 nAddress0;
    /* 0x14 */ s32 nAddress1;
...
} __anon_0x375A8; // size = 0x48

typedef union __anon_0x37884 {
    /* 0x0 */ char _0s8;
    /* 0x1 */ char _1s8;
    /* 0x2 */ char _2s8;
    /* 0x3 */ char _3s8;
...
} __anon_0x38474; // size = 0x84

typedef struct _CPU_ADDRESS {
    /* 0x0 */ s32 nN64;
    /* 0x4 */ s32 nHost;
    /* 0x8 */ struct cpu_function* pFunction;
} __anon_0x386B5; // size = 0xC

typedef struct __anon_0x3876A {
    /* 0x0 */ u32 nAddress;
    /* 0x4 */ u32 nOpcodeOld;
    /* 0x8 */ u32 nOpcodeNew;
} __anon_0x3876A; // size = 0xC
...
typedef struct _CPU {
    ...
    /* 0x00040 */ union __anon_0x37884 aGPR[32];
    /* 0x00140 */ union __anon_0x37C98 aFPR[32];
    ...
    /* 0x00B64 */ struct __anon_0x381A6* apDevice[256];
    ...
    /* 0x11EA8 */ struct __anon_0x3876A aCodeHack[32];
...
} __anon_0x38DB4; // size = 0x12090

typedef enum __anon_0x3944B {
    MIT_NONE = -1,
    MIT_SP = 0,
    MIT_SI = 1,
    MIT_AI = 2,
...
typedef struct __anon_0x394C6 {
    /* 0x00 */ char* szType;
    /* 0x04 */ u32 nMask;
    /* 0x08 */ enum __anon_0x39A12 eCode;
    /* 0x0C */ enum __anon_0x39863 eType;
    /* 0x10 */ enum __anon_0x3944B eTypeMips;
} __anon_0x394C6; // size = 0x14

typedef enum __anon_0x39594 {
    SOT_NONE = -1,
    SOT_CPU = 0,
    SOT_PIF = 1,
    SOT_RAM = 2,
...
struct __anon_0x37307* gpSystem;

typedef struct __anon_0x3A8CE {
...
typedef struct CARDFileInfo {
    ...
    /* 0x10 */ u16 iBlock;
    /* 0x12 */ u16 __padding;
} __anon_0x3ABDF; // size = 0x14

typedef struct __anon_0x3ACD7 {
    /* 0x000 */ s32 currentGame;
    /* 0x004 */ s32 fileSize;
    /* 0x008 */ char name[33];
    /* 0x02C */ s32 numberOfGames;
    /* 0x030 */ struct __anon_0x3A8CE game;
...
} __anon_0x3ACD7; // size = 0x35C

typedef enum __anon_0x3AEED {
    MC_E_NONE = 0,
    MC_E_BUSY = 1,
    MC_E_WRONGDEVICE = 2,
    MC_E_NOCARD = 3,
...
typedef struct _MCARD {
    /* 0x000 */ struct __anon_0x3ACD7 file;
    /* 0x35C */ enum __anon_0x3AEED error;
    /* 0x360 */ s32 slot;
...
} __anon_0x3BA96; // size = 0x3C

typedef enum __anon_0x3BB6E {
    RLM_NONE = -1,
    RLM_PART = 0,
    RLM_FULL = 1,
    RLM_COUNT_ = 2,
...
typedef struct __anon_0x3BBD0 {
    /* 0x0 */ s32 iCache;
    /* 0x4 */ u32 nSize;
    /* 0x8 */ u32 nTickUsed;
    /* 0xC */ char keep;
} __anon_0x3BBD0; // size = 0x10

typedef struct __anon_0x3BCE4 {
    /* 0x00 */ s32 bWait;
    /* 0x04 */ s32 (* pCallback)();
    /* 0x08 */ u8* pTarget;
    /* 0x0C */ u32 nSize;
    /* 0x10 */ u32 nOffset;
} __anon_0x3BCE4; // size = 0x14

typedef struct __anon_0x3BDC4 {
    /* 0x00 */ s32 bWait;
    /* 0x04 */ s32 bDone;
    /* 0x08 */ s32 nResult;
    /* 0x0C */ u8* anData;
    ...
    /* 0x28 */ u32 nSize;
    /* 0x2C */ u32 nSizeRead;
} __anon_0x3BDC4; // size = 0x30

typedef struct __anon_0x3BFAF {
    /* 0x00000 */ void* pHost;
    ...
    /* 0x00214 */ u32 nSize;
    /* 0x00218 */ enum __anon_0x3BB6E eModeLoad;
    /* 0x0021C */ struct __anon_0x3BBD0 aBlock[4096];
    /* 0x1021C */ u32 nTick;
    /* 0x10220 */ u8* pCacheRAM;
    /* 0x10224 */ u8 anBlockCachedRAM[1024];
    /* 0x10624 */ u8 anBlockCachedARAM[2046];
    /* 0x10E24 */ struct __anon_0x3BCE4 copy;
    /* 0x10E38 */ struct __anon_0x3BDC4 load;
...
} __anon_0x3BFAF; // size = 0x10EF8

typedef enum __anon_0x3C33E {
    CT_NONE = 0,
    CT_CONTROLLER = 1,
...
typedef struct __anon_0x3C417 {
    /* 0x00 */ void* pROM;
    /* 0x04 */ void* pRAM;
    /* 0x08 */ void* pHost;
    /* 0x0C */ u16 controllerType[5];
    /* 0x16 */ char controllerStatus[5];
    /* 0x1C */ enum __anon_0x3C33E eControllerType[5];
} __anon_0x3C417; // size = 0x30

// Range: 0x80030B44 -> 0x80030EEC
static s32 systemSetupGameRAM(struct __anon_0x37307* pSystem) {
    // Parameters
    // struct __anon_0x37307* pSystem; // r27
    ...
    s32 nSizeExtra; // r3
    struct __anon_0x3BFAF* pROM; // r29
    u32 nCode; // r28
    u32 iCode; // r1+0x8
...
// Range: 0x80030370 -> 0x80030B44
s32 systemGetInitialConfiguration(struct __anon_0x3BFAF* pROM, s32 index) {
    // Parameters
    // struct __anon_0x3BFAF* pROM; // r24
    // s32 index; // r1+0x10
...
// Range: 0x8002DD7C -> 0x80030370
static s32 systemSetupGameALL(struct __anon_0x37307* pSystem) {
    // Parameters
    // struct __anon_0x37307* pSystem; // r18
    ...
    struct __anon_0x3BFAF* pROM; // r19
    struct __anon_0x3C417* pPIF; // r29
...
// Erased
static s32 systemClearExceptions(struct __anon_0x37307* pSystem) {
    // Parameters
    // struct __anon_0x37307* pSystem; // r1+0x0

    // Local variables
    s32 iException; // r1+0x0
}

// Range: 0x8002DBA0 -> 0x8002DD7C
static s32 systemGetException(enum __anon_0x39863 eType, struct __anon_0x394C6* pException) {
    // Parameters
    // enum __anon_0x39863 eType; // r1+0x4
    // struct __anon_0x394C6* pException; // r1+0x8
}

// Range: 0x8002DB90 -> 0x8002DBA0
static s32 systemGet8(char* pData) {
    // Parameters
    // char* pData; // r1+0x8
}

// Range: 0x8002DB80 -> 0x8002DB90
static s32 systemGet16(s16* pData) {
    // Parameters
    // s16* pData; // r1+0x8
}

// Range: 0x8002DB70 -> 0x8002DB80
static s32 systemGet32(s32* pData) {
    // Parameters
    // s32* pData; // r1+0x8
}

// Range: 0x8002DB5C -> 0x8002DB70
static s32 systemGet64(s64* pData) {
    // Parameters
    // s64* pData; // r1+0x8
}

// Range: 0x8002DB54 -> 0x8002DB5C
static s32 systemPut8() {}

// Range: 0x8002DB4C -> 0x8002DB54
static s32 systemPut16() {}

// Range: 0x8002DB44 -> 0x8002DB4C
static s32 systemPut32() {}

// Range: 0x8002DB3C -> 0x8002DB44
static s32 systemPut64() {}

// Range: 0x8002DA04 -> 0x8002DB3C
...
// Range: 0x8002D910 -> 0x8002DA04
s32 systemCopyROM(struct __anon_0x37307* pSystem, s32 nOffsetRAM, s32 nOffsetROM, s32 nSize, s32 (* pCallback)()) {
    // Parameters
    // struct __anon_0x37307* pSystem; // r29
    // s32 nOffsetRAM; // r4
    // s32 nOffsetROM; // r30
    // s32 nSize; // r1+0x14
    // s32 (* pCallback)(); // r31
...
// Erased
static s32 systemSetBreak(struct __anon_0x37307* pSystem, s64 nAddress) {
    // Parameters
    // struct __anon_0x37307* pSystem; // r1+0x0
    // s64 nAddress; // r1+0x8
}
...
// Erased
static s32 systemClearBreak(struct __anon_0x37307* pSystem) {
    // Parameters
    // struct __anon_0x37307* pSystem; // r1+0x0
}

// Range: 0x8002D8A0 -> 0x8002D910
s32 systemSetMode(struct __anon_0x37307* pSystem, enum __anon_0x3A14C eMode) {
    // Parameters
    // struct __anon_0x37307* pSystem; // r30
    // enum __anon_0x3A14C eMode; // r31

    // References
    // -> struct _XL_OBJECTTYPE gClassSystem;
}

// Range: 0x8002D838 -> 0x8002D8A0
s32 systemGetMode(struct __anon_0x37307* pSystem, enum __anon_0x3A14C* peMode) {
    // Parameters
    // struct __anon_0x37307* pSystem; // r30
    // enum __anon_0x3A14C* peMode; // r31

    // References
    // -> struct _XL_OBJECTTYPE gClassSystem;
}

// Range: 0x8002D74C -> 0x8002D838
s32 systemSetStorageDevice(struct __anon_0x37307* pSystem, enum __anon_0x39594 storageDevice) {
    // Parameters
    // struct __anon_0x37307* pSystem; // r30
    // enum __anon_0x39594 storageDevice; // r31
...
// Range: 0x8002D73C -> 0x8002D74C
s32 systemGetStorageDevice(struct __anon_0x37307* pSystem, enum __anon_0x39594* pStorageDevice) {
    // Parameters
    // struct __anon_0x37307* pSystem; // r1+0x0
    // enum __anon_0x39594* pStorageDevice; // r1+0x4
}

// Range: 0x8002D584 -> 0x8002D73C
s32 systemReset(struct __anon_0x37307* pSystem) {
    // Parameters
    // struct __anon_0x37307* pSystem; // r29
    ...
    s64 nPC; // r1+0x10
    s32 nOffsetRAM; // r4
    enum __anon_0x39594 eObject; // r30
}

// Range: 0x8002D488 -> 0x8002D584
s32 systemExecute(struct __anon_0x37307* pSystem, s32 nCount) {
    // Parameters
    // struct __anon_0x37307* pSystem; // r31
    // s32 nCount; // r4
...
// Range: 0x8002D330 -> 0x8002D488
s32 systemCheckInterrupts(struct __anon_0x37307* pSystem) {
    // Parameters
    // struct __anon_0x37307* pSystem; // r25
    ...
    s32 bUsed; // r28
    s32 bDone; // r27
    struct __anon_0x394C6 exception; // r1+0xC
    enum __anon_0x39A12 eCodeFinal; // r26
}

// Range: 0x8002D2F8 -> 0x8002D330
s32 systemExceptionPending(struct __anon_0x37307* pSystem, enum __anon_0x39863 eType) {
    // Parameters
    // struct __anon_0x37307* pSystem; // r1+0x0
    // enum __anon_0x39863 eType; // r1+0x4
}

// Range: 0x8002CA20 -> 0x8002D2F8
s32 systemEvent(struct __anon_0x37307* pSystem, s32 nEvent, void* pArgument) {
    // Parameters
    // struct __anon_0x37307* pSystem; // r31
    // s32 nEvent; // r1+0xC
    // void* pArgument; // r26
    ...
    struct __anon_0x394C6 exception; // r1+0x1C
    enum __anon_0x39594 eObject; // r1+0x8
    enum __anon_0x39594 storageDevice; // r1+0x8
