/*
    Compile unit: C:\WINDOWS\Profiles\slee\Desktop\ENGLISH ZELDA\Fire\library.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8008F170 -> 0x80097818
*/
...
} __anon_0x78EA9; // size = 0x10

// size = 0x10, address = 0x800F1014
struct _XL_OBJECTTYPE gClassLibrary;

// size = 0x100, address = 0x800F1024
static u32 __osRcpImTable[64];

// size = 0x4, address = 0x80137828
static f32 dtor$466;

// size = 0x4, address = 0x8013782C
static f32 dtor$480;

// size = 0x4, address = 0x80137830
static u32 nAddress$605;

typedef struct __anon_0x7905A {
    /* 0x0 */ s32 nOffsetHost;
    /* 0x4 */ s32 nAddressN64;
} __anon_0x7905A; // size = 0x8

typedef struct cpu_callerID {
    /* 0x0 */ s32 N64address;
    /* 0x4 */ s32 GCNaddress;
} __anon_0x790C0; // size = 0x8

typedef struct cpu_function {
    /* 0x00 */ void* pnBase;
    /* 0x04 */ void* pfCode;
    /* 0x08 */ s32 nCountJump;
    /* 0x0C */ struct __anon_0x7905A* aJump;
    /* 0x10 */ s32 nAddress0;
    /* 0x14 */ s32 nAddress1;
...
} __anon_0x79133; // size = 0x48

typedef union __anon_0x7940F {
    /* 0x0 */ char _0s8;
    /* 0x1 */ char _1s8;
    /* 0x2 */ char _2s8;
    /* 0x3 */ char _3s8;
...
} __anon_0x79EC3; // size = 0x84

typedef struct _CPU_ADDRESS {
    /* 0x0 */ s32 nN64;
    /* 0x4 */ s32 nHost;
    /* 0x8 */ struct cpu_function* pFunction;
} __anon_0x7A104; // size = 0xC

typedef struct __anon_0x7A1B9 {
    /* 0x0 */ u32 nAddress;
    /* 0x4 */ u32 nOpcodeOld;
    /* 0x8 */ u32 nOpcodeNew;
} __anon_0x7A1B9; // size = 0xC
...
typedef struct _CPU {
    ...
    /* 0x00040 */ union __anon_0x7940F aGPR[32];
    /* 0x00140 */ union __anon_0x7D4AE aFPR[32];
    ...
    /* 0x00B64 */ struct __anon_0x79BF5* apDevice[256];
    ...
    /* 0x11EA8 */ struct __anon_0x7A1B9 aCodeHack[32];
...
} __anon_0x7A803; // size = 0x12090

typedef struct __anon_0x7AEE3 {
    /* 0x0 */ char* szName;
    /* 0x4 */ void (* pfLibrary)(struct _CPU*);
    /* 0x8 */ u32 anData[17];
} __anon_0x7AEE3; // size = 0x4C

// size = 0x1008, address = 0x800F1434
struct __anon_0x7AEE3 gaFunction[54];

typedef struct __anon_0x7AFF9 {
    /* 0x00 */ s32 nFlag;
    /* 0x04 */ void* pHost;
    /* 0x08 */ s32 nAddStackSwap;
    /* 0x0C */ s32 nCountFunction;
    /* 0x10 */ s32 nAddressException;
    /* 0x14 */ struct __anon_0x7AEE3* aFunction;
    /* 0x18 */ void* apData[10];
    /* 0x40 */ s32 anAddress[10];
} __anon_0x7AFF9; // size = 0x68

typedef struct __anon_0x7BD54 {
    /* 0x0 */ f32 f_odd;
    /* 0x4 */ f32 f_even;
} __anon_0x7BD54; // size = 0x8

typedef union __anon_0x7BDAF {
    /* 0x0 */ struct __anon_0x7BD54 f;
    /* 0x0 */ f64 d;
    /* 0x0 */ s64 u64;
} __anon_0x7BDAF;

typedef struct __anon_0x7BE23 {
    /* 0x000 */ u64 at;
    /* 0x008 */ u64 v0;
    /* 0x010 */ u64 v1;
    /* 0x018 */ u64 a0;
    ...
    /* 0x108 */ u32 rcp;
    /* 0x10C */ u32 fpcsr;
    /* 0x110 */ union __anon_0x7BDAF fp0;
    /* 0x118 */ union __anon_0x7BDAF fp2;
    /* 0x120 */ union __anon_0x7BDAF fp4;
    /* 0x128 */ union __anon_0x7BDAF fp6;
    /* 0x130 */ union __anon_0x7BDAF fp8;
    /* 0x138 */ union __anon_0x7BDAF fp10;
    /* 0x140 */ union __anon_0x7BDAF fp12;
    /* 0x148 */ union __anon_0x7BDAF fp14;
    /* 0x150 */ union __anon_0x7BDAF fp16;
    /* 0x158 */ union __anon_0x7BDAF fp18;
    /* 0x160 */ union __anon_0x7BDAF fp20;
    /* 0x168 */ union __anon_0x7BDAF fp22;
    /* 0x170 */ union __anon_0x7BDAF fp24;
    /* 0x178 */ union __anon_0x7BDAF fp26;
    /* 0x180 */ union __anon_0x7BDAF fp28;
    /* 0x188 */ union __anon_0x7BDAF fp30;
} __anon_0x7BE23; // size = 0x190
...
typedef struct __OSThread_s {
    ...
    /* 0x14 */ s32 id;
    /* 0x18 */ s32 fp;
    /* 0x20 */ struct __anon_0x7BE23 context;
} __anon_0x7C4EC; // size = 0x1B0
...
typedef struct OSMesgQueue_s {
    ...
    /* 0x10 */ s32 msgCount;
    /* 0x14 */ void* msg;
} __anon_0x7C654; // size = 0x18

typedef struct __anon_0x7C75C {
    /* 0x0 */ u16 type;
    /* 0x2 */ u8 pri;
    /* 0x3 */ u8 status;
    /* 0x4 */ struct OSMesgQueue_s* retQueue;
} __anon_0x7C75C; // size = 0x8

typedef struct __anon_0x7C800 {
    /* 0x00 */ struct __anon_0x7C75C hdr;
    /* 0x08 */ void* dramAddr;
    /* 0x0C */ u32 devAddr;
    /* 0x10 */ u32 size;
    /* 0x14 */ void* piHandle;
} __anon_0x7C800; // size = 0x18

typedef struct __anon_0x7D2E8 {
    /* 0x0 */ u8 col[3];
    /* 0x3 */ char pad1;
    /* 0x4 */ u8 colc[3];
    /* 0x7 */ char pad2;
    /* 0x8 */ s8 dir[3];
    /* 0xB */ char pad3;
} __anon_0x7D2E8; // size = 0xC

typedef union __anon_0x7D3E8 {
    /* 0x0 */ struct __anon_0x7D2E8 l;
    /* 0x0 */ s64 force_structure_alignment[2];
} __anon_0x7D3E8;

typedef struct __anon_0x7D478 {
    /* 0x0 */ union __anon_0x7D3E8 l[2];
} __anon_0x7D478; // size = 0x20

typedef union __anon_0x7D4AE {
    /* 0x0 */ f32 _0f32;
    /* 0x4 */ f32 f32;
    /* 0x0 */ f64 f64;
    /* 0x0 */ s32 _0s32;
...
typedef struct __anon_0x7DD1A {
    /* 0x0 */ s32 x1;
    /* 0x4 */ s32 y1;
    /* 0x8 */ s32 x2;
    /* 0xC */ s32 y2;
} __anon_0x7DD1A; // size = 0x10

typedef union __anon_0x7DDCC {
    /* 0x0 */ struct __anon_0x7DD1A h;
    /* 0x0 */ s32 force_structure_alignment[4];
} __anon_0x7DDCC;

typedef struct __anon_0x7FBAB {
    /* 0x0 */ f32 rX;
    /* 0x4 */ f32 rY;
    /* 0x8 */ f32 rSizeX;
    /* 0xC */ f32 rSizeY;
} __anon_0x7FBAB; // size = 0x10

typedef struct __anon_0x7FC45 {
    /* 0x00 */ s32 nSize;
    /* 0x04 */ s32 nWidth;
    /* 0x08 */ s32 nFormat;
    /* 0x0C */ void* pData;
    /* 0x10 */ s32 nAddress;
} __anon_0x7FC45; // size = 0x14

typedef struct __anon_0x7FD86 {
    /* 0x0 */ f32 x;
    /* 0x4 */ f32 y;
    /* 0x8 */ f32 z;
} __anon_0x7FD86; // size = 0xC

typedef struct __anon_0x7FDF6 {
    /* 0x00 */ s32 bTransformed;
    /* 0x04 */ struct __anon_0x7FD86 rVecOrigTowards;
    /* 0x10 */ f32 rColorR;
    /* 0x14 */ f32 rColorG;
    /* 0x18 */ f32 rColorB;
    /* 0x1C */ f32 rVectorX;
    ...
    /* 0x36 */ s16 coordY;
    /* 0x38 */ s16 coordZ;
} __anon_0x7FDF6; // size = 0x3C

typedef struct __anon_0x80026 {
    /* 0x00 */ s32 bTransformed;
    /* 0x04 */ struct __anon_0x7FD86 rS;
    /* 0x10 */ struct __anon_0x7FD86 rT;
    /* 0x1C */ struct __anon_0x7FD86 rSRaw;
    /* 0x28 */ struct __anon_0x7FD86 rTRaw;
} __anon_0x80026; // size = 0x34

typedef struct __anon_0x8010F {
    /* 0x00 */ f32 rSum;
    /* 0x04 */ f32 rS;
    /* 0x08 */ f32 rT;
    /* 0x0C */ struct __anon_0x7FD86 vec;
    /* 0x18 */ u8 anColor[4];
} __anon_0x8010F; // size = 0x1C

typedef union __anon_0x8026E {
    /* 0x0 */ u8 u8[4096];
    /* 0x0 */ u16 u16[2048];
    /* 0x0 */ u32 u32[1024];
    /* 0x0 */ u64 u64[512];
...
typedef struct __anon_0x8030B {
    /* 0x0 */ union __anon_0x8026E data;
} __anon_0x8030B; // size = 0x1000
...
typedef struct _GXTlutObj {
    /* 0x0 */ u32 dummy[3];
} __anon_0x80566; // size = 0xC

typedef struct _GXTexObj {
    /* 0x0 */ u32 dummy[8];
} __anon_0x805CD; // size = 0x20
...
} __anon_0x8067C; // size = 0x6C

typedef struct __anon_0x809D9 {
    /* 0x00 */ s32 nSize;
    /* 0x04 */ s32 nTMEM;
    /* 0x08 */ s32 iTLUT;
    /* 0x0C */ s32 nSizeX;
    ...
    /* 0x26 */ s16 nY1;
    /* 0x28 */ u32 nCodePixel;
} __anon_0x809D9; // size = 0x2C

typedef enum __anon_0x80CBB {
    FMP_NONE = -1,
    FMP_PERSPECTIVE = 0,
    FMP_ORTHOGRAPHIC = 1,
} __anon_0x80CBB;

typedef struct __anon_0x80D40 {
    /* 0x00 */ s32 nCount;
    /* 0x04 */ f32 rScale;
    /* 0x08 */ f32 rAspect;
    ...
    /* 0x20 */ enum __anon_0x80CBB eProjection;
} __anon_0x80D40; // size = 0x24
...
typedef struct _GXColor {
    ...
    /* 0x2 */ u8 b;
    /* 0x3 */ u8 a;
} __anon_0x80ED5; // size = 0x4

typedef struct __anon_0x80F90 {
    ...
    /* 0x000B8 */ struct __anon_0x7FBAB viewport;
    /* 0x000C8 */ struct __anon_0x7FC45 aBuffer[4];
    ...
    /* 0x00140 */ struct __anon_0x7FDF6 aLight[8];
    /* 0x00320 */ struct __anon_0x80026 lookAt;
    /* 0x00354 */ s32 nCountVertex;
    /* 0x00358 */ struct __anon_0x8010F aVertex[80];
    /* 0x00C18 */ struct __anon_0x8030B TMEM;
    ...
    /* 0x3C350 */ s32 nLastX1;
    /* 0x3C354 */ s32 nLastY1;
    /* 0x3C358 */ struct __anon_0x809D9 aTile[8];
...
} __anon_0x80F90; // size = 0x3D150

// Range: 0x80096B34 -> 0x80097818
static s32 __osException(struct _CPU* pCPU) {
    ...
    // Local variables
    s32 iBit; // r3
    struct __anon_0x7AFF9* pLibrary; // r1+0x8
    s64 nData64; // r1+0x28
    s64 nCause; // r1+0x20
    struct __OSThread_s* __osRunningThread; // r1+0x18
    struct __anon_0x79BF5** apDevice; // r31
    u8* aiDevice; // r30
    u32 nStatus; // r22
...
static s32 send_mesg(struct _CPU* pCPU) {
    ...
    // Local variables
    struct __anon_0x7AFF9* pLibrary; // r1+0x8
    struct __anon_0x79BF5** apDevice; // r30
    u8* aiDevice; // r29
}

// Range: 0x800964B8 -> 0x800967A4
static s32 __osEnqueueAndYield(struct _CPU* pCPU) {
    ...
    // Local variables
    s64 nData64; // r1+0x18
    struct __anon_0x7AFF9* pLibrary; // r3
    struct __OSThread_s* __osRunningThread; // r1+0x10
    u32 __OSGlobalIntMask; // r31
    u32 nStatus; // r1+0x8
    u32 nData32; // r5
    u32 nMask; // r1+0xC
    struct __anon_0x79BF5** apDevice; // r6
    u8* aiDevice; // r7
}

// Range: 0x80096290 -> 0x800964B8
...
// Range: 0x8009599C -> 0x800959D0
static void __cosf(struct _CPU* pCPU) {
    // Parameters
    // struct _CPU* pCPU; // r31
}

// Range: 0x80095968 -> 0x8009599C
static void __sinf(struct _CPU* pCPU) {
    // Parameters
    // struct _CPU* pCPU; // r31
}

// Range: 0x80095924 -> 0x80095968
...
void guMtxCatF(struct _CPU* pCPU) {
    ...
    union __anon_0x7D4AE data1; // r1+0x30
    union __anon_0x7D4AE data2; // r1+0x28
    u32* mf; // r1+0x24
    u32* nf; // r1+0x20
    u32* res; // r1+0x1C
}

// Range: 0x800952C8 -> 0x800954D0
void guMtxF2L(struct _CPU* pCPU) {
    ...
    s32 j; // r1+0x8
    s32* m; // r1+0x20
    union __anon_0x7D4AE data; // r1+0x18
    s32* ai; // r9
    s32* af; // r10
}

// Range: 0x800951F4 -> 0x800952C8
void guMtxIdentF(struct _CPU* pCPU) {
    ...
    s32 i; // r7
    s32 j; // r1+0x8
    union __anon_0x7D4AE data1; // r1+0x18
    union __anon_0x7D4AE data0; // r1+0x10
}

// Range: 0x80095140 -> 0x800951F4
...
void guOrthoF(struct _CPU* pCPU) {
    ...
    f32 f; // f30
    f32 scale; // f5
    union __anon_0x7D4AE data0; // r1+0x20
    union __anon_0x7D4AE data1; // r1+0x18
    union __anon_0x7D4AE data; // r1+0x10
}

// Range: 0x80094BF4 -> 0x80094ED0
void guOrtho(struct _CPU* pCPU) {
    ...
    s32 e1; // r7
    s32 e2; // r8
    union __anon_0x7D4AE data; // r1+0x58
    f32 mf[4][4]; // r1+0x18
    u32* sp; // r1+0x14
    s32* ai; // r9
    s32* af; // r10
...
void GenPerspective_1080(struct _CPU* pCPU) {
    ...
    f32 rNear; // f1
    f32 rFar; // f2
    struct __anon_0x80F90* pFrame; // r31
}

// Range: 0x800944FC -> 0x80094624
void guScaleF(struct _CPU* pCPU) {
    ...
    s32 j; // r4
    u32* mf; // r1+0x20
    union __anon_0x7D4AE data0; // r1+0x18
    union __anon_0x7D4AE data1; // r1+0x10
}

// Range: 0x80094310 -> 0x800944FC
...
void guRotateF(struct _CPU* pCPU) {
    ...
    u32* mf; // r1+0x2C
    u32* sp; // r1+0x28
    union __anon_0x7D4AE data; // r1+0x20
    union __anon_0x7D4AE data0; // r1+0x18
    union __anon_0x7D4AE data1; // r1+0x10
    f32 sine; // r1+0x8
    f32 cosine; // r1+0x8
...
void guLookAtF(struct _CPU* pCPU) {
    ...
    f32 yRight; // f10
    f32 zRight; // f11
    union __anon_0x7D4AE data; // r1+0x28
    union __anon_0x7D4AE data0; // r1+0x20
    union __anon_0x7D4AE data1; // r1+0x18
}

// Range: 0x80093204 -> 0x8009361C
...
// Range: 0x800928B0 -> 0x80093204
void guLookAtHiliteF(struct _CPU* pCPU) {
    // Parameters
    // struct _CPU* pCPU; // r31

    // Local variables
    struct __anon_0x7D478* l; // r1+0x3C
    union __anon_0x7DDCC* h; // r1+0x38
    union __anon_0x7D4AE data; // r1+0x30
    u32* mf; // r1+0x2C
    u32* sp; // r1+0x28
    f32 len; // f5
    f32 xLook; // r1+0x8
...
// Range: 0x80091EDC -> 0x800928B0
void guLookAtHilite(struct _CPU* pCPU) {
    // Parameters
    // struct _CPU* pCPU; // r31

    // Local variables
    struct __anon_0x7D478* l; // r1+0x84
    union __anon_0x7DDCC* h; // r1+0x80
    s32 i; // r7
    s32 j; // r1+0x8
    s32 e1; // r5
    s32 e2; // r8
    union __anon_0x7D4AE data; // r1+0x78
    f32 mf[4][4]; // r1+0x38
    u32* m; // r1+0x34
    u32* sp; // r1+0x30
    s32* ai; // r9
...
// Range: 0x80091988 -> 0x80091EDC
void guLookAtReflectF(struct _CPU* pCPU) {
    // Parameters
    // struct _CPU* pCPU; // r31

    // Local variables
    struct __anon_0x7D478* l; // r1+0x28
    union __anon_0x7D4AE data; // r1+0x20
    u32* mf; // r1+0x1C
    u32* sp; // r1+0x18
    f32 xEye; // f3
...
// Range: 0x800913B4 -> 0x80091988
void guLookAtReflect(struct _CPU* pCPU) {
    // Parameters
    // struct _CPU* pCPU; // r31

    // Local variables
    struct __anon_0x7D478* l; // r1+0x70
    s32 i; // r7
    s32 j; // r1+0x8
    s32 e1; // r5
    s32 e2; // r8
    union __anon_0x7D4AE data; // r1+0x68
    f32 mf[4][4]; // r1+0x28
    u32* m; // r1+0x24
    u32* sp; // r1+0x20
    s32* ai; // r9
...
// Range: 0x80090CE4 -> 0x80090CF4
s32 pictureSnap_Zelda2(struct _CPU* pCPU) {
    // Parameters
    // struct _CPU* pCPU; // r1+0x0
}

// Range: 0x80090BBC -> 0x80090CE4
s32 dmaSoundRomHandler_ZELDA1(struct _CPU* pCPU) {
    ...
    u32* msg; // r1+0x10
    struct __anon_0x7C800* pIOMessage; // r1+0xC
    s32 first; // r30
    s32 msgCount; // r29
    s32 validCount; // r28
    s32 nSize; // r6
...
// Range: 0x80090B40 -> 0x80090B54
s32 zeldaLoadSZS_Entry(struct _CPU* pCPU) {
    // Parameters
    // struct _CPU* pCPU; // r1+0x0
}

// Range: 0x80090B2C -> 0x80090B40
s32 zeldaLoadSZS_Exit(struct _CPU* pCPU) {
    // Parameters
    // struct _CPU* pCPU; // r1+0x0
}

// Range: 0x8009082C -> 0x80090B2C
static s32 libraryFindException(struct __anon_0x7AFF9* pLibrary, s32 bException) {
    // Parameters
    // struct __anon_0x7AFF9* pLibrary; // r27
    // s32 bException; // r28

    // Local variables
    struct _CPU* pCPU; // r30
    struct __anon_0x79BF5** apDevice; // r29
    u8* aiDevice; // r31
    u32 anCode[6]; // r1+0x10
}

// Range: 0x800900F8 -> 0x8009082C
static s32 libraryFindVariables(struct __anon_0x7AFF9* pLibrary) {
    // Parameters
    // struct __anon_0x7AFF9* pLibrary; // r24

    // Local variables
    struct _CPU* pCPU; // r27
    struct __anon_0x79BF5** apDevice; // r26
    u8* aiDevice; // r25
    u32 nAddress; // r23
...
// Range: 0x8008FBE8 -> 0x800900F8
static s32 libraryFindFunctions(struct __anon_0x7AFF9* pLibrary) {
    // Parameters
    // struct __anon_0x7AFF9* pLibrary; // r24
    ...
    struct _CPU* pCPU; // r3
    s32 iFunction; // r29
    struct __anon_0x79BF5** apDevice; // r28
    u8* aiDevice; // r27
    u32 nOpcode; // r1+0x10
    u32* pnCode; // r1+0xC
    u32 nAddress; // r29
...
// Erased
static s32 libraryCheckHandler(struct __anon_0x7AFF9* pLibrary, s32 bException) {
    // Parameters
    // struct __anon_0x7AFF9* pLibrary; // r31
    // s32 bException; // r4
}

// Range: 0x8008F600 -> 0x8008FBE8
s32 libraryTestFunction(struct __anon_0x7AFF9* pLibrary, struct cpu_function* pFunction) {
    // Parameters
    // struct __anon_0x7AFF9* pLibrary; // r30
...
// Range: 0x8008F49C -> 0x8008F600
static s32 librarySearch(struct __anon_0x7AFF9* pLibrary, struct cpu_function* pFunction) {
    // Parameters
    // struct __anon_0x7AFF9* pLibrary; // r29
...
// Erased
static s32 libraryUpdate(struct __anon_0x7AFF9* pLibrary) {
    // Parameters
    // struct __anon_0x7AFF9* pLibrary; // r31
...
// Range: 0x8008F2B0 -> 0x8008F3A8
s32 libraryCall(struct __anon_0x7AFF9* pLibrary, struct _CPU* pCPU, s32 iFunction) {
    // Parameters
    // struct __anon_0x7AFF9* pLibrary; // r29
    // struct _CPU* pCPU; // r30
    // s32 iFunction; // r31
...
// Range: 0x8008F170 -> 0x8008F2B0
s32 libraryEvent(struct __anon_0x7AFF9* pLibrary, s32 nEvent, void* pArgument) {
    // Parameters
    // struct __anon_0x7AFF9* pLibrary; // r30
    // s32 nEvent; // r1+0xC
