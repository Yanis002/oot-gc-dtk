/*
    Compile unit: C:\WINDOWS\Profiles\slee\Desktop\ENGLISH ZELDA\Fire\_frameGCNcc.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80097E18 -> 0x80098720
*/
...
// size = 0x40, address = 0x800F26C0
static enum _GXTevStageID ganNameTevStage[16];

// size = 0x5, address = 0x80137870
static u8 sOrder[5];
...
} __anon_0x852FA; // size = 0x14

// size = 0x64, address = 0x800F2700
static struct TevColorOp sTevColorOp[5];

// size = 0x5, address = 0x80137878
static u8 sReplace[5];

// size = 0x50, address = 0x800F2764
static enum _GXTevColorArg sTevColorArg[5][4];

// size = 0x50, address = 0x800F27B4
static enum _GXTevAlphaArg sTevAlphaArg[5][4];

// size = 0x40, address = 0x800F2898
static char* sColorNames[16];

// size = 0x40, address = 0x800F28D8
static char* sAlphaNames[2][8];

// size = 0x40, address = 0x800F2918
static char* strings$288[4][4];

typedef enum __anon_0x85920 {
    SM_NONE = -1,
    SM_RUNNING = 0,
    SM_STOPPED = 1,
} __anon_0x85920;

typedef struct __anon_0x8598A {
    /* 0x0 */ s32 nSize;
    /* 0x4 */ s32 nOffsetRAM;
    /* 0x8 */ s32 nOffsetROM;
    /* 0xC */ s32 (* pCallback)();
} __anon_0x8598A; // size = 0x10

typedef enum __anon_0x85A3B {
    SRT_NONE = -1,
    SRT_MARIO = 0,
    SRT_WAVERACE = 1,
    SRT_MARIOKART = 2,
...
typedef struct __anon_0x85CB2 {
    /* 0x00 */ void* pFrame;
    /* 0x04 */ void* pSound;
    /* 0x08 */ s32 bException;
    /* 0x0C */ enum __anon_0x85920 eMode;
    /* 0x10 */ struct __anon_0x8598A romCopy;
    /* 0x20 */ enum __anon_0x85A3B eTypeROM;
    /* 0x24 */ void* apObject[16];
    /* 0x68 */ u64 nAddressBreak;
    /* 0x70 */ enum __anon_0x85B6F storageDevice;
    /* 0x74 */ u8 anException[16];
    /* 0x84 */ s32 bJapaneseVersion;
} __anon_0x85CB2; // size = 0x88

// size = 0x4, address = 0x80137B00
struct __anon_0x85CB2* gpSystem;

typedef struct __anon_0x85EE3 {
    /* 0x0 */ f32 rX;
    /* 0x4 */ f32 rY;
    /* 0x8 */ f32 rSizeX;
    /* 0xC */ f32 rSizeY;
} __anon_0x85EE3; // size = 0x10

typedef struct __anon_0x85F7D {
    /* 0x00 */ s32 nSize;
    /* 0x04 */ s32 nWidth;
    /* 0x08 */ s32 nFormat;
    /* 0x0C */ void* pData;
    /* 0x10 */ s32 nAddress;
} __anon_0x85F7D; // size = 0x14

typedef struct __anon_0x860BE {
    /* 0x0 */ f32 x;
    /* 0x4 */ f32 y;
    /* 0x8 */ f32 z;
} __anon_0x860BE; // size = 0xC

typedef struct __anon_0x8612E {
    /* 0x00 */ s32 bTransformed;
    /* 0x04 */ struct __anon_0x860BE rVecOrigTowards;
    /* 0x10 */ f32 rColorR;
    /* 0x14 */ f32 rColorG;
    /* 0x18 */ f32 rColorB;
    /* 0x1C */ f32 rVectorX;
    ...
    /* 0x36 */ s16 coordY;
    /* 0x38 */ s16 coordZ;
} __anon_0x8612E; // size = 0x3C

typedef struct __anon_0x8635E {
    /* 0x00 */ s32 bTransformed;
    /* 0x04 */ struct __anon_0x860BE rS;
    /* 0x10 */ struct __anon_0x860BE rT;
    /* 0x1C */ struct __anon_0x860BE rSRaw;
    /* 0x28 */ struct __anon_0x860BE rTRaw;
} __anon_0x8635E; // size = 0x34

typedef struct __anon_0x86447 {
    /* 0x00 */ f32 rSum;
    /* 0x04 */ f32 rS;
    /* 0x08 */ f32 rT;
    /* 0x0C */ struct __anon_0x860BE vec;
    /* 0x18 */ u8 anColor[4];
} __anon_0x86447; // size = 0x1C

typedef union __anon_0x865A6 {
    /* 0x0 */ u8 u8[4096];
    /* 0x0 */ u16 u16[2048];
    /* 0x0 */ u32 u32[1024];
    /* 0x0 */ u64 u64[512];
...
typedef struct __anon_0x86643 {
    /* 0x0 */ union __anon_0x865A6 data;
} __anon_0x86643; // size = 0x1000
...
typedef struct _GXTlutObj {
    /* 0x0 */ u32 dummy[3];
} __anon_0x8689E; // size = 0xC

typedef struct _GXTexObj {
    /* 0x0 */ u32 dummy[8];
} __anon_0x86905; // size = 0x20
...
} __anon_0x869B4; // size = 0x6C

typedef struct __anon_0x86D11 {
    /* 0x00 */ s32 nSize;
    /* 0x04 */ s32 nTMEM;
    /* 0x08 */ s32 iTLUT;
    /* 0x0C */ s32 nSizeX;
    ...
    /* 0x26 */ s16 nY1;
    /* 0x28 */ u32 nCodePixel;
} __anon_0x86D11; // size = 0x2C

typedef enum __anon_0x86FF3 {
    FMP_NONE = -1,
    FMP_PERSPECTIVE = 0,
    FMP_ORTHOGRAPHIC = 1,
} __anon_0x86FF3;

typedef struct __anon_0x8707C {
    /* 0x00 */ s32 nCount;
    /* 0x04 */ f32 rScale;
    /* 0x08 */ f32 rAspect;
    ...
    /* 0x20 */ enum __anon_0x86FF3 eProjection;
} __anon_0x8707C; // size = 0x24

typedef struct __anon_0x87233 {
    ...
    /* 0x000B8 */ struct __anon_0x85EE3 viewport;
    /* 0x000C8 */ struct __anon_0x85F7D aBuffer[4];
    ...
    /* 0x00140 */ struct __anon_0x8612E aLight[8];
    /* 0x00320 */ struct __anon_0x8635E lookAt;
    /* 0x00354 */ s32 nCountVertex;
    /* 0x00358 */ struct __anon_0x86447 aVertex[80];
    /* 0x00C18 */ struct __anon_0x86643 TMEM;
    ...
    /* 0x3C350 */ s32 nLastX1;
    /* 0x3C354 */ s32 nLastY1;
    /* 0x3C358 */ struct __anon_0x86D11 aTile[8];
...
} __anon_0x884B4; // size = 0x2B8

// size = 0x0, address = 0x800ECDB8
enum _GXTexCoordID ganNameTexCoord[];

// size = 0x0, address = 0x800ECD78
...
typedef struct _GXColor {
    ...
    /* 0x2 */ u8 b;
    /* 0x3 */ u8 a;
} __anon_0x8902D; // size = 0x4

// Range: 0x8009841C -> 0x80098720
static void SetTableTevStages(struct __anon_0x87233* pFrame, struct CombineModeTev* ctP) {
    // Parameters
    // struct __anon_0x87233* pFrame; // r30
...
// Erased
static void CheckNewCCMode(struct __anon_0x87233* pFrame, s32 numCycles) {
    // Parameters
    // struct __anon_0x87233* pFrame; // r1+0x8
    // s32 numCycles; // r29
...
// Range: 0x8009825C -> 0x8009841C
void SetNumTexGensChans(struct __anon_0x87233* pFrame, s32 numCycles) {
    // Parameters
    // struct __anon_0x87233* pFrame; // r1+0x8
...
// Range: 0x80097ED8 -> 0x8009825C
void SetTevStages(struct __anon_0x87233* pFrame, s32 cycle) {
    // Parameters
    // struct __anon_0x87233* pFrame; // r1+0x8
    // s32 cycle; // r17
...
// Range: 0x80097E18 -> 0x80097ED8
s32 SetTevStageTable(struct __anon_0x87233* pFrame, s32 numCycles) {
    // Parameters
    // struct __anon_0x87233* pFrame; // r31
    // s32 numCycles; // r7
