/*
    Compile unit: C:\WINDOWS\Profiles\slee\Desktop\ENGLISH ZELDA\Fire\codeGCN.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8001C450 -> 0x8001C4A4
*/
...
typedef struct tXL_FILE {
    ...
    /* 0x10 */ s32 nSize;
    /* 0x14 */ s32 nOffset;
    /* 0x18 */ enum __anon_0x1FA1F eType;
    /* 0x1C */ struct DVDFileInfo info;
} __anon_0x1FF25; // size = 0x58

// size = 0x4, address = 0x80137B80
static void* gpBufferFunction;

// size = 0x4, address = 0x80137B84
