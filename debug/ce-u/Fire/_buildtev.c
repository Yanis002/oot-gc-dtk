/*
    Compile unit: C:\WINDOWS\Profiles\slee\Desktop\ENGLISH ZELDA\Fire\_buildtev.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80098720 -> 0x8009BB38
*/
...
} __anon_0x898D7; // size = 0x14

// size = 0x50, address = 0x800F29D0
static struct TevColorOp sUsualOps[4];

// size = 0x10, address = 0x800F2A20
static enum _GXTevColorArg sUsualCArgs[4];

// size = 0x10, address = 0x800F2A30
static enum _GXTevAlphaArg sUsualAArgs[4];

// size = 0x8, address = 0x80137900
static s32 zeroType$182[2];

// size = 0x20, address = 0x800F2A40
static s32 texelType$183[2][4];

// size = 0x10, address = 0x800F2A60
...
} __anon_0x89FE4; // size = 0x2B8

// size = 0x2B8, address = 0x80133150
static struct CombineModeTev tevStages$519;

typedef enum __anon_0x8AA85 {
    SM_NONE = -1,
    SM_RUNNING = 0,
    SM_STOPPED = 1,
} __anon_0x8AA85;

typedef struct __anon_0x8AAED {
    /* 0x0 */ s32 nSize;
    /* 0x4 */ s32 nOffsetRAM;
    /* 0x8 */ s32 nOffsetROM;
    /* 0xC */ s32 (* pCallback)();
} __anon_0x8AAED; // size = 0x10

typedef enum __anon_0x8AB9E {
    SRT_NONE = -1,
    SRT_MARIO = 0,
    SRT_WAVERACE = 1,
    SRT_MARIOKART = 2,
...
typedef struct __anon_0x8AE11 {
    /* 0x00 */ void* pFrame;
    /* 0x04 */ void* pSound;
    /* 0x08 */ s32 bException;
    /* 0x0C */ enum __anon_0x8AA85 eMode;
    /* 0x10 */ struct __anon_0x8AAED romCopy;
    /* 0x20 */ enum __anon_0x8AB9E eTypeROM;
    /* 0x24 */ void* apObject[16];
    /* 0x68 */ u64 nAddressBreak;
    /* 0x70 */ enum __anon_0x8ACD0 storageDevice;
    /* 0x74 */ u8 anException[16];
    /* 0x84 */ s32 bJapaneseVersion;
} __anon_0x8AE11; // size = 0x88

// size = 0x4, address = 0x80137B00
struct __anon_0x8AE11* gpSystem;

// Range: 0x8009B990 -> 0x8009BB38
