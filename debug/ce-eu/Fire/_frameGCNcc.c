/*
    Compile unit: C:\WINDOWS\Profiles\slee\Desktop\EUROPE ZELDA\Fire\_frameGCNcc.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80098F30 -> 0x80099838
*/
...
// size = 0x40, address = 0x8013C4E8
static enum _GXTevStageID ganNameTevStage[16];

// size = 0x5, address = 0x801816B0
static u8 sOrder[5];
...
} __anon_0x88E51; // size = 0x14

// size = 0x64, address = 0x8013C528
static struct TevColorOp sTevColorOp[5];

// size = 0x5, address = 0x801816B8
static u8 sReplace[5];

// size = 0x50, address = 0x8013C58C
static enum _GXTevColorArg sTevColorArg[5][4];

// size = 0x50, address = 0x8013C5DC
static enum _GXTevAlphaArg sTevAlphaArg[5][4];

// size = 0x40, address = 0x8013C6C0
static char* sColorNames[16];

// size = 0x40, address = 0x8013C700
static char* sAlphaNames[2][8];

// size = 0x40, address = 0x8013C740
static char* strings$289[4][4];

typedef enum __anon_0x89477 {
    SM_NONE = -1,
    SM_RUNNING = 0,
    SM_STOPPED = 1,
} __anon_0x89477;

typedef struct __anon_0x894E2 {
    /* 0x0 */ s32 nSize;
    /* 0x4 */ s32 nOffsetRAM;
    /* 0x8 */ s32 nOffsetROM;
    /* 0xC */ s32 (* pCallback)();
} __anon_0x894E2; // size = 0x10

typedef enum __anon_0x89593 {
    SRT_NONE = -1,
    SRT_MARIO = 0,
    SRT_WAVERACE = 1,
    SRT_MARIOKART = 2,
...
typedef struct __anon_0x8980A {
    /* 0x00 */ void* pFrame;
    /* 0x04 */ void* pSound;
    /* 0x08 */ s32 bException;
    /* 0x0C */ enum __anon_0x89477 eMode;
    /* 0x10 */ struct __anon_0x894E2 romCopy;
    /* 0x20 */ enum __anon_0x89593 eTypeROM;
    /* 0x24 */ void* apObject[16];
    /* 0x68 */ u64 nAddressBreak;
    /* 0x70 */ enum __anon_0x896C7 storageDevice;
    /* 0x74 */ u8 anException[16];
    /* 0x84 */ s32 bJapaneseVersion;
} __anon_0x8980A; // size = 0x88

// size = 0x4, address = 0x80181944
struct __anon_0x8980A* gpSystem;

typedef struct __anon_0x89A3B {
    /* 0x0 */ f32 rX;
    /* 0x4 */ f32 rY;
    /* 0x8 */ f32 rSizeX;
    /* 0xC */ f32 rSizeY;
} __anon_0x89A3B; // size = 0x10

typedef struct __anon_0x89AD5 {
    /* 0x00 */ s32 nSize;
    /* 0x04 */ s32 nWidth;
    /* 0x08 */ s32 nFormat;
    /* 0x0C */ void* pData;
    /* 0x10 */ s32 nAddress;
} __anon_0x89AD5; // size = 0x14

typedef struct __anon_0x89C16 {
    /* 0x0 */ f32 x;
    /* 0x4 */ f32 y;
    /* 0x8 */ f32 z;
} __anon_0x89C16; // size = 0xC

typedef struct __anon_0x89C86 {
    /* 0x00 */ s32 bTransformed;
    /* 0x04 */ struct __anon_0x89C16 rVecOrigTowards;
    /* 0x10 */ f32 rColorR;
    /* 0x14 */ f32 rColorG;
    /* 0x18 */ f32 rColorB;
    /* 0x1C */ f32 rVectorX;
    ...
    /* 0x36 */ s16 coordY;
    /* 0x38 */ s16 coordZ;
} __anon_0x89C86; // size = 0x3C

typedef struct __anon_0x89EB6 {
    /* 0x00 */ s32 bTransformed;
    /* 0x04 */ struct __anon_0x89C16 rS;
    /* 0x10 */ struct __anon_0x89C16 rT;
    /* 0x1C */ struct __anon_0x89C16 rSRaw;
    /* 0x28 */ struct __anon_0x89C16 rTRaw;
} __anon_0x89EB6; // size = 0x34

typedef struct __anon_0x89F9F {
    /* 0x00 */ f32 rSum;
    /* 0x04 */ f32 rS;
    /* 0x08 */ f32 rT;
    /* 0x0C */ struct __anon_0x89C16 vec;
    /* 0x18 */ u8 anColor[4];
} __anon_0x89F9F; // size = 0x1C

typedef union __anon_0x8A0FE {
    /* 0x0 */ u8 u8[4096];
    /* 0x0 */ u16 u16[2048];
    /* 0x0 */ u32 u32[1024];
    /* 0x0 */ u64 u64[512];
...
typedef struct __anon_0x8A19B {
    /* 0x0 */ union __anon_0x8A0FE data;
} __anon_0x8A19B; // size = 0x1000
...
typedef struct _GXTlutObj {
    /* 0x0 */ u32 dummy[3];
} __anon_0x8A3F6; // size = 0xC

typedef struct _GXTexObj {
    /* 0x0 */ u32 dummy[8];
} __anon_0x8A45D; // size = 0x20
...
} __anon_0x8A50C; // size = 0x6C

typedef struct __anon_0x8A869 {
    /* 0x00 */ s32 nSize;
    /* 0x04 */ s32 nTMEM;
    /* 0x08 */ s32 iTLUT;
    /* 0x0C */ s32 nSizeX;
    ...
    /* 0x26 */ s16 nY1;
    /* 0x28 */ u32 nCodePixel;
} __anon_0x8A869; // size = 0x2C

typedef enum __anon_0x8AB4B {
    FMP_NONE = -1,
    FMP_PERSPECTIVE = 0,
    FMP_ORTHOGRAPHIC = 1,
} __anon_0x8AB4B;

typedef struct __anon_0x8ABD4 {
    /* 0x00 */ s32 nCount;
    /* 0x04 */ f32 rScale;
    /* 0x08 */ f32 rAspect;
    ...
    /* 0x20 */ enum __anon_0x8AB4B eProjection;
} __anon_0x8ABD4; // size = 0x24

typedef struct __anon_0x8AD8B {
    ...
    /* 0x000B8 */ struct __anon_0x89A3B viewport;
    /* 0x000C8 */ struct __anon_0x89AD5 aBuffer[4];
    ...
    /* 0x00140 */ struct __anon_0x89C86 aLight[8];
    /* 0x00320 */ struct __anon_0x89EB6 lookAt;
    /* 0x00354 */ s32 nCountVertex;
    /* 0x00358 */ struct __anon_0x89F9F aVertex[80];
    /* 0x00C18 */ struct __anon_0x8A19B TMEM;
    ...
    /* 0x3C350 */ s32 nLastX1;
    /* 0x3C354 */ s32 nLastY1;
    /* 0x3C358 */ struct __anon_0x8A869 aTile[8];
...
} __anon_0x8C00C; // size = 0x2B8

// size = 0x0, address = 0x80136B60
enum _GXTexCoordID ganNameTexCoord[];

// size = 0x0, address = 0x80136B20
...
typedef struct _GXColor {
    ...
    /* 0x2 */ u8 b;
    /* 0x3 */ u8 a;
} __anon_0x8CB85; // size = 0x4

// Range: 0x80099534 -> 0x80099838
static void SetTableTevStages(struct __anon_0x8AD8B* pFrame, struct CombineModeTev* ctP) {
    // Parameters
    // struct __anon_0x8AD8B* pFrame; // r30
...
// Erased
static void CheckNewCCMode(struct __anon_0x8AD8B* pFrame, s32 numCycles) {
    // Parameters
    // struct __anon_0x8AD8B* pFrame; // r1+0x8
    // s32 numCycles; // r29
...
// Range: 0x80099374 -> 0x80099534
void SetNumTexGensChans(struct __anon_0x8AD8B* pFrame, s32 numCycles) {
    // Parameters
    // struct __anon_0x8AD8B* pFrame; // r1+0x8
...
// Range: 0x80098FF0 -> 0x80099374
void SetTevStages(struct __anon_0x8AD8B* pFrame, s32 cycle) {
    // Parameters
    // struct __anon_0x8AD8B* pFrame; // r1+0x8
    // s32 cycle; // r17
...
// Range: 0x80098F30 -> 0x80098FF0
s32 SetTevStageTable(struct __anon_0x8AD8B* pFrame, s32 numCycles) {
    // Parameters
    // struct __anon_0x8AD8B* pFrame; // r31
    // s32 numCycles; // r7
