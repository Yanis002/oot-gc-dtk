/*
    Compile unit: C:\WINDOWS\Profiles\slee\Desktop\EUROPE ZELDA\Core\xlText.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800060B0 -> 0x800061A4
*/
