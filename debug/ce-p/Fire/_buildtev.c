/*
    Compile unit: C:\WINDOWS\Profiles\slee\Desktop\EUROPE ZELDA\Fire\_buildtev.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80099838 -> 0x8009CC50
*/
...
} __anon_0x8D42E; // size = 0x14

// size = 0x50, address = 0x8013C7F8
static struct TevColorOp sUsualOps[4];

// size = 0x10, address = 0x8013C848
static enum _GXTevColorArg sUsualCArgs[4];

// size = 0x10, address = 0x8013C858
static enum _GXTevAlphaArg sUsualAArgs[4];

// size = 0x8, address = 0x80181740
static s32 zeroType$183[2];

// size = 0x20, address = 0x8013C868
static s32 texelType$184[2][4];

// size = 0x10, address = 0x8013C888
static s32 lightType$185[2][2];
...
} __anon_0x8DB3B; // size = 0x2B8

// size = 0x2B8, address = 0x8017CF50
static struct CombineModeTev tevStages$520;

typedef enum __anon_0x8E5DC {
    SM_NONE = -1,
    SM_RUNNING = 0,
    SM_STOPPED = 1,
} __anon_0x8E5DC;

typedef struct __anon_0x8E645 {
    /* 0x0 */ s32 nSize;
    /* 0x4 */ s32 nOffsetRAM;
    /* 0x8 */ s32 nOffsetROM;
    /* 0xC */ s32 (* pCallback)();
} __anon_0x8E645; // size = 0x10

typedef enum __anon_0x8E6F6 {
    SRT_NONE = -1,
    SRT_MARIO = 0,
    SRT_WAVERACE = 1,
    SRT_MARIOKART = 2,
...
typedef struct __anon_0x8E969 {
    /* 0x00 */ void* pFrame;
    /* 0x04 */ void* pSound;
    /* 0x08 */ s32 bException;
    /* 0x0C */ enum __anon_0x8E5DC eMode;
    /* 0x10 */ struct __anon_0x8E645 romCopy;
    /* 0x20 */ enum __anon_0x8E6F6 eTypeROM;
    /* 0x24 */ void* apObject[16];
    /* 0x68 */ u64 nAddressBreak;
    /* 0x70 */ enum __anon_0x8E828 storageDevice;
    /* 0x74 */ u8 anException[16];
    /* 0x84 */ s32 bJapaneseVersion;
} __anon_0x8E969; // size = 0x88

// size = 0x4, address = 0x80181944
struct __anon_0x8E969* gpSystem;

// Range: 0x8009CAA8 -> 0x8009CC50
