/*
    Compile unit: C:\WINDOWS\Profiles\slee\Desktop\EUROPE ZELDA\Fire\_cpuGCN.c
    Producer: MW EABI PPC C-Compiler
    Language: C89
    Code range: 0x80036BB8 -> 0x800686B0
*/
...
s32 cpuMakeFunction(struct _CPU* pCPU, struct cpu_function** ppFunction, s32 nAddressN64) {
    ...
    struct __anon_0x40DAB aJump[1024]; // r1+0x18
}
...
static s32 cpuExecuteUpdate(struct _CPU* pCPU, s32* pnAddressGCN, u32 nCount) {
    ...
    // Local variables
    enum __anon_0x4788D eModeUpdate; // r4
    struct __anon_0x40A47* pSystem; // r31
    s32 nDelta; // r1+0x8
    u32 nCounter; // r1+0x8
    u32 nCompare; // r1+0x8
...
static s32 cpuExecuteOpcode(struct _CPU* pCPU, s32 nCount, s32 nAddressN64, s32 nAddressGCN) {
    ...
    u32 nOpcode; // r30
    u32* opcode; // r1+0x6C
    struct __anon_0x41A82** apDevice; // r28
    u8* aiDevice; // r29
    s32 iEntry; // r4
    s32 nCount; // r22
    char nData8; // r1+0x66
...
static s32 cpuExecuteIdle(struct _CPU* pCPU, s32 nCount, s32 nAddressN64, s32 nAddressGCN) {
    ...
    // Local variables
    struct __anon_0x4740E* pROM; // r30
}

// Range: 0x80039700 -> 0x800397D0
